...
public abstract class AbstractClientFrame extends JFrame implements Runnable
{
	...
	/**
	 * Map associant une couleur Ã  un nom afin que l'on n'ai pas Ã  générer
	 * une couleur Ã  chaque fois que l'on a besoin d'une couleur pour un nom.
	 * Cette map est mise Ã  jour dans {@link #getColorFromName(String)}
	 */
	protected Map<String, Color> colorMap;

	/**
	 * Constructeur [protégé] de la fenÃªtre de chat abstraite
	 * @param name le nom de l'utilisateur
	 * @param host l'hÃ´te sur lequel on est connecté
	...
	/**
	 * Couleur d'un texte d'aprÃ¨s le contenu du texte.
	 * @param name le texte
	...
	{
		/*
		 * DONE renvoyer une couleur (pas trop claire) d'aprÃ¨s le nom
	...
	/**
	 * Fermeture de la fenÃ¨tre et des flux Ã  la fin de l'exécution
	 */
	public void cleanup()
	{
