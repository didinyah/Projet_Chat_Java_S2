...
public class ChatClient implements Runnable
{
	                  ...
	                  Logger parentLogger)
	{
		 ...
		 * les "severe" doivent àªtre suivi d'un System.exit(...) comme ci-dessus;
		 */
		serverOut = null;
		try
		{
		 ...
		 * et d'un warning si celui ci a des erreurs aprà¨s l'envoi du nom au
		 * serveur.
		 */
		if (serverOut != null)
		{
	...
	/**
	 * Accà¨s en lecture de l'état du client
	 *
	 * @return the ready
	 * @uml.property name="ready"
	 */
	...
	public void run()
	{
		 ...
		 * consultent (de manià¨re atomique) cette variable afin de savoir s'ils
		 * peuvent continuer
		 */
