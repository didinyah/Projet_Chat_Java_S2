...
public class RunChatClient extends AbstractRunChat
{
	...
	/**
	 * Nom d'utilisateur Ã  utiliser pour se connecter au serveur. Si le nom
	 * n'est pas fournit
	 */
	private String name;
	...
	/**
	 * Indique si le client Ã  créer est un GUI ou pas
	 */
	private boolean gui;

	/**
	 * La version de l'interface graphique Ã  lancer:
	 * <ul>
	 * 	<li>version 1 correspond Ã  l'utilisation d'une ClientFrame</li>
	 * 	<li>version 2 correspond Ã  l'utilisation d'une SuperClientFrame</li>
	 * </ul>
	 */
	...
	/**
	 * Constructeur d'un lanceur de client d'aprÃ¨s les arguments du programme
	 * principal
	 *
	...
	protected RunChatClient(String[] args)
	{
		...
		/*
		 * Initialisation des flux d'I/O utilisateur Ã  null
		 * ils dépendront du client Ã  créer (console ou GUI)
		 */
		userIn = null;
		userOut = null;
	...
	protected void setAttributes(String[] args)
	{
		 ...
		 * -v | --verbose
		 * -p | --port : port Ã  utiliser pour la serverSocket
		 */
		super.setAttributes(args);

		/*
		 * On met d'abord les attributs locaux Ã  leur valeur par défaut
		 */
		host = null;
		name = null;
		gui = false;
	...
	protected void launch()
	{
		...
		if (gui)
		{
			...
			/*
			 * Création de la fenÃªtre de chat
			 * TODO Ã  customizer lorsrque vous aurez créé la classe
			 * ClientFrame2
			 */
			...
			/*
			 * TODO Création du flux de sortie vers le GUI : userOut Ã  partir du
			 * flux d'entrée de la frame (ClientFrame#getInPipe())
			 * 	- Creation d'un PipedOutputStream Ã  connecter sur
			...
			/*
			 * TODO Création du flux d'entrée depuis le GUI : userIn Ã  partir du
			 * flux de sortie de la frame (ClientFrame#getOutPipe())
			 * 	- Création d'un PipedInputStream Ã  connecter sur
			...
			/*
			 * Insertion de la frame dans la file des évÃ¨nements GUI
			 * grÃ¢ce Ã  un Runnable anonyme
			 */
